...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        ...
        <form action="{{ isset($admin) ? route('admin.domains.new') : route('domains.new') }}" method="post" enctype="multipart/form-data">
            @csrf

            <div class="form-group">
                <label for="i_name">{{ __('Domain') }}</label>
                <input type="text" dir="ltr" name="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" id="i_name" value="{{ old('name') }}">
                @if ($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input type="text" dir="ltr" name="index_page" id="i_index_page" class="form-control{{ $errors->has('index_page') ? ' is-invalid' : '' }}" value="{{ old('index_page') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" dir="ltr" name="not_found_page" id="i_not_found_page" class="form-control{{ $errors->has('not_found_page') ? ' is-invalid' : '' }}" value="{{ old('not_found_page') }}">
