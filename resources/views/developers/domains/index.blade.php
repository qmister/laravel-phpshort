...
@section('site_title', formatTitle([__('Domains'), __('Developers'), config('settings.title')]))
...
@section('content')
    <div class="bg-base-1 flex-fill">
        <div class="container h-100 py-3 my-3">
            ...
            <h2 class="mb-0 d-inline-block">{{ __('Domains') }}</h2>
...
<div class="bg-dark text-light p-3 rounded d-flex align-items-center mb-3" dir="ltr">
    ...
    <pre class="m-0 text-light">{{ route('domains.index') }}</pre>
</div>
...
curl --location --request GET '{{ route('domains.index') }}' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer <span class="text-success">{api_key}</span>'
</pre>

                @include('developers.domains.list', ['type' => 0])
                </div>
            </div>
...
<div class="bg-dark text-light p-3 rounded d-flex align-items-center mb-3" dir="ltr">
<span class="badge bg-light text-success px-2 py-1 mr-3">GET</span>
<pre class="m-0 text-light">{!! str_replace(':id', '<span class="text-success">{id}</span>', route('domains.show', ['id' => ':id'])) !!}</pre>
</div>
...
<pre class="bg-dark text-light p-3 mb-0 rounded text-left" dir="ltr">
curl --location --request GET '{!! str_replace(':id', '<span class="text-success">{id}</span>', route('domains.show', ['id' => ':id'])) !!}' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer <span class="text-success">{api_key}</span>'
</pre>
                </div>
...
<pre class="m-0 text-light">{{ route('domains.store') }}</pre>
</div>
                    <p class="mb-1">
                        {{ __('Request example') }}:
                    </p>
<pre class="bg-dark text-light p-3 rounded text-left" dir="ltr">
curl --location --request POST '{{ route('domains.store') }}' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--header 'Authorization: Bearer <span class="text-success">{api_key}</span>' \
--data-urlencode 'url=<span class="text-success">{url}</span>'
</pre>

                    @include('developers.domains.store_update', ['type' => 1])
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="bg-dark text-light p-3 rounded d-flex align-items-center mb-3" dir="ltr">
                        ...
                        <pre class="m-0 text-light">{!! str_replace(':id', '<span class="text-success">{id}</span>', route('domains.update', ['id' => ':id'])) !!}</pre>
                    </div>
                    ...
                    <pre class="bg-dark text-light p-3 rounded text-left" dir="ltr">
curl --location --request PUT '{!! str_replace(':id', '<span class="text-success">{id}</span>', route('domains.update', ['id' => ':id'])) !!}' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--header 'Authorization: Bearer <span class="text-success">{api_key}</span>' \
--data-urlencode 'url=<span class="text-success">{url}</span>'
</pre>

                    @include('developers.domains.store_update', ['type' => 0])
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="bg-dark text-light p-3 rounded d-flex align-items-center mb-3" dir="ltr">
                        ...
                        <pre class="m-0 text-light">{!! str_replace(':id', '<span class="text-success">{id}</span>', route('domains.destroy', ['id' => ':id'])) !!}</pre>
                    </div>
                    ...
                    <pre class="bg-dark text-light p-3 mb-0 rounded text-left" dir="ltr">
curl --location --request DELETE '{!! str_replace(':id', '<span class="text-success">{id}</span>', route('domains.destroy', ['id' => ':id'])) !!}' \
--header 'Authorization: Bearer <span class="text-success">{api_key}</span>'
</pre>
                </div>
            </div>
